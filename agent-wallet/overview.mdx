...
| OAuth-only agent access | MCP and CLI wallet tools require core `mcp:tools`; external MCP also requires the full profile and workspace-owner identity. Workspace API keys cannot access them. |
