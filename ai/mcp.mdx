...
| `400` `paybox_amount_below_dust_floor` / `paybox_amount_value_mismatch` | The implied value is under about $0.01 or disagrees with `value_cents`. Restate the amount instead of retrying it unchanged. |
