...
| `mermail-agent-wallet` | Inspect Agent Wallet and use PayBox's live tools and signing UI (MCP OAuth + wallet scopes) |
...
see [Agent Wallet](/agent-wallet/overview) and
...
- **Improve official skills** — fix wording, scenarios, docs, or propose a new skill that maps to Mermail MCP tools via PRs on [mermail-skills](https://github.com/Nudgen-Marketing/mermail-skills). See [CONTRIBUTING.md](https://github.com/Nudgen-Marketing/mermail-skills/blob/main/CONTRIBUTING.md) and [AUTHORING.md](https://github.com/Nudgen-Marketing/mermail-skills/blob/main/AUTHORING.md).
