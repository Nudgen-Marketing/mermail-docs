...
| Hermes Agent | MCP OAuth via `~/.hermes/config.yaml` `auth: oauth`, then `hermes mcp login mermail` |
...
switch skills. Ordinary mailbox operations use their focused MCP skill; invoke
