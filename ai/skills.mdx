...
| `mermail-agent-wallet` | Inspect PayBox Agent Wallet balances, submit approved USDC transfers, and run catalog-token transfers with `amount_decimal` (MCP OAuth + wallet scopes) |
