...
<Tabs>
  ...
  <Tab title="ChatGPT">
    Use **ChatGPT Connectors** (Streamable HTTP, OAuth — leave auth empty). Follow the ChatGPT steps on [mermail.app/agents](https://mermail.app/agents): the guide prefers opening the ChatGPT desktop app Settings when installed, with a web Connectors fallback.
  </Tab>
</Tabs>
