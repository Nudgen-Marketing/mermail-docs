...
| `/.well-known/mcp/server-card.json` | MCP server card (Streamable HTTP + OAuth 2.1 and optional API key) — see [MCP](/ai/mcp) |
| `/.well-known/agent-skills/index.json` | Agent skill index — see [Skills](/ai/skills) |
