...
third-party signup, authentication event, purchase, subscription, or payment.
Require confirmation at each consequential external-action boundary. Require
the separate MCP confirmation token before destructive mailbox or workspace
actions.
